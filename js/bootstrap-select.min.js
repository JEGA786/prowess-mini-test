...
!function(a, b) {
    ...
    !function(a) {
        ...
        var e = a.fn.val;
        a.fn.val = function(a) {
            return this.is("select") && a && this.find('option[value="' + a + '"]').data("selected", !0),
        ...
        g.prototype = {
            ...
            keydown: function(c) {
                ...
                if (o.options.liveSearch && (/(^9$|27)/.test(c.keyCode.toString(10)) && l && 0 === o.$menu.find(".active").length && (c.preventDefault(),
